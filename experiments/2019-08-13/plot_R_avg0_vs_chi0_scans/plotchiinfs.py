...
if __name__=="__main__":
    ...
    chis,ld = get_2d_array(5,chi0s,R_avg0s)

    cs = ax.contourf(R_avg0s,chi0s,chis,levels=30)
    ...
    cbar.ax.set_ylabel(r"$\chi(t\to\infty)$")

    fig.subplots_adjust(left=0.18,bottom=0.15)
    fig.savefig(ld.file_savename("chiinfty"))
