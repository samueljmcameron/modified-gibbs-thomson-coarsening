...
if __name__=="__main__":
    ...
    convergences,ld = get_2d_array(-1,chi0s,R_avg0s)

    convergences = convergences.astype(int)

    cs = ax.contourf(R_avg0s,chi0s,convergences,levels=2,cmap="Pastel1")
    ...
    fig.savefig(ld.file_savename("convergence"))
